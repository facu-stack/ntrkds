...
--
-- Host: localhost    Database: ntrkids
-- ------------------------------------------------------
...
INSERT INTO `acceso` VALUES (3,'padre@gmail.com','12345','paciente'),(4,'doctor@gmail.com','12345','doctor');
...
INSERT INTO `clinica` VALUES (1,'Central',1);
/*!40000 ALTER TABLE `clinica` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `codigoarea`
--
...
CREATE TABLE `codigoarea` (
  `ID_CodigoArea` int NOT NULL AUTO_INCREMENT,
  `codigoArea` int NOT NULL,
  PRIMARY KEY (`ID_CodigoArea`),
  UNIQUE KEY `ID_CodigoArea_UNIQUE` (`ID_CodigoArea`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `codigoarea`
--

LOCK TABLES `codigoarea` WRITE;
/*!40000 ALTER TABLE `codigoarea` DISABLE KEYS */;
INSERT INTO `codigoarea` VALUES (1,3777);
/*!40000 ALTER TABLE `codigoarea` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `datos_tutor` (
  ...
  KEY `accesoFK_idx` (`accesoID`),
  KEY `tutorCodigoArea_idx` (`codigoArea`),
  CONSTRAINT `accesoFK` FOREIGN KEY (`accesoID`) REFERENCES `acceso` (`ID_Acceso`),
  CONSTRAINT `tutoAccesoFK` FOREIGN KEY (`ID_usuario`) REFERENCES `acceso` (`ID_Acceso`),
  CONSTRAINT `tutorCodigoArea` FOREIGN KEY (`codigoArea`) REFERENCES `codigoarea` (`ID_CodigoArea`),
...
INSERT INTO `datos_tutor` VALUES (3,'Juan','Doe','Avenida Siempreviva 742',1,1,'123456','22333444',3);
...
CREATE TABLE `especialista` (
  ...
  `codigoareaID` int NOT NULL,
  `Telefono` varchar(6) NOT NULL,
  `email` varchar(45) NOT NULL,
  `accesoID` int NOT NULL,
  PRIMARY KEY (`idUsuario`),
  UNIQUE KEY `idUsuario_UNIQUE` (`idUsuario`),
  KEY `codigoAreaFK_idx` (`codigoareaID`),
  KEY `accesoFK_idx` (`accesoID`),
  KEY `clinikaFK_idx` (`ClinicaID`),
  CONSTRAINT `accesoEspecialistaFK` FOREIGN KEY (`accesoID`) REFERENCES `acceso` (`ID_Acceso`),
  CONSTRAINT `clinikaFK` FOREIGN KEY (`ClinicaID`) REFERENCES `clinica` (`idClinica`),
  CONSTRAINT `codigoAreaFK` FOREIGN KEY (`codigoareaID`) REFERENCES `codigoarea` (`ID_CodigoArea`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `especialista` VALUES (3,'Marco','Polo','Nutricion Infantil',1,1,'334455','doctor@gmail.com',4);
...
CREATE TABLE `localidad` (
  ...
  KEY `ProvinciaFK_idx` (`ProvinciaID`),
  CONSTRAINT `ProvinciaFK` FOREIGN KEY (`ProvinciaID`) REFERENCES `provincia` (`idProvincia`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `localidad` VALUES (1,'3450','Goya',1);
...
CREATE TABLE `paciente_tutor` (
  ...
  PRIMARY KEY (`ID`),
  KEY `PacientesTutor_idx` (`paciente_id`),
  KEY `TutorPacientes_idx` (`tutor_id`),
  CONSTRAINT `PacientesTutor` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`ID_usuario`),
  CONSTRAINT `TutorPacientes` FOREIGN KEY (`tutor_id`) REFERENCES `datos_tutor` (`ID_usuario`)
...
INSERT INTO `paciente_tutor` VALUES (2,1,3);
...
INSERT INTO `pacientes` VALUES (1,'CalleFalsa 123','Ana','Doe','2014-01-01','12345678',1,'1');
...
INSERT INTO `provincia` VALUES (1,'Corrientes');
...
CREATE TABLE `turnos` (
  ...
  KEY `PacienteFK_idx` (`Paciente_ID`),
  KEY `Especialista_idx` (`Especialista_ID`),
  CONSTRAINT `Especialista` FOREIGN KEY (`Especialista_ID`) REFERENCES `especialista` (`idUsuario`),
  CONSTRAINT `PacienteFK` FOREIGN KEY (`Paciente_ID`) REFERENCES `pacientes` (`ID_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-19 17:12:14
