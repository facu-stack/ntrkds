// ✅ Obtener el tipo de usuario desde la variable de Flask, NO de localStorage
...
if (tipoUsuario && tipoUsuario !== "invitado") {
  ...
  if (tipoUsuario === "paciente") {
    crearTarjeta("Cita.png", "Agendar un turno", "/formulario");
    ...
    crearTarjeta("pacientes.png", "Lista de pacientes", "/profesionales");
